...
public class WalletRepository : Repository<Wallet>, IWalletRepository
{
    ...
    public async Task<Wallet?> GetWalletDetails(Guid walletId, Guid userId)
    {
    ...
    public async Task<Wallet?> GetActiveWallet(Guid userId)
    {
    ...
    public async Task<Wallet?> GetActiveWalletDetails(Guid userId)
    {
